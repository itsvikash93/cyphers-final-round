  ...
  return (
    <div className="font-[Minecraft] relative min-h-[100vh] w-full">
      ...
      <div className="border-b-[1px] relative flex items-end border-zinc-600 h-[90vh] w-full">
        ...
        <h1 className="uppercase text-lg md:text-3xl px-4 md:px-15 font-[Aux-mono] absolute w-full bottom-5 left-0 text-start">
    ...
    &lt;/div&gt;</code> </h1>
        ...
        <h1 className="uppercase px-4 md:px-15 h-[45%] text-[#9D2117] w-full text-[15vw] md:text-[15vw]">
          Cyphers
        </h1>
      </div>
